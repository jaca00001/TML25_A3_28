...
def attack(model, images, labels, epsilon=None,ll=False,alpha=None,rand=False,iters=1):
...
def fgsm_attack(model, images, labels, epsilon=None, ll=False):
    return attack(model, images, labels, epsilon=epsilon,alpha=None, ll=ll, rand=False, iters=1)
...
def r_fgsm_attack(model, images, labels, epsilon=None,ll=False):
    return attack(model, images, labels, epsilon=epsilon,alpha=None, ll=ll, rand=True, iters=1)
...
def pgd_attack(model, images, labels, eps=8/255, alpha=2/255, iters=10, ll=False):
    return attack(model, images, labels, epsilon=eps, ll=ll,alpha=alpha, rand=False, iters=iters)
...
def r_pgd_attack(model, images, labels, eps=8/255, alpha=2/255, iters=10, ll=False):
    return attack(model, images, labels, epsilon=eps, ll=ll,alpha= alpha, rand=True, iters=iters)